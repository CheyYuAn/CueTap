...
if [[ "$mode" == --unit ]]; then
    xcrun xctest -XCTest DemoControllerTests,DemoScriptTests,CommandOptionsTests,ConfigurationCLITests,DemoInputSourceTests,DemoHotkeyTests,RuntimeSettingsTests,MultiSegmentTests,ConfigurationStoreTests,ConfigurationCommandsTests,DoctorTests,CompletionLockTests,EditorRulesTests,VirtualEditorTests,KeystrokeCompilerTests,TextDiffTests,CompileCLITests build/products/Debug/CueTapTests.xctest \
